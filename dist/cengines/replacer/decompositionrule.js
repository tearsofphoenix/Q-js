...
all gates matching the gate_class.
   */
function DecompositionRule(gateClass, gateDecomposer) {
    var gateRecognizer = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function () {
        return true;
    };

    _classCallCheck(this, DecompositionRule);

    // Check for common gate_class type mistakes.
    if (gateClass instanceof _basics.BasicGate) {
    ...
    if (!(0, _util.isKindclassOf)(gateClass, _basics.BasicGate)) {
...
exports.default = DecompositionRule;