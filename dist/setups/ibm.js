...
var _ibm5qubitmapper = require('../cengines/ibm5qubitmapper');
...
function getEngineList() {
  ...
  return [new _tagremover2.default(), new _optimize2.default(10), new _replacer.AutoReplacer(rule_set), new _tagremover2.default(), new _ibm5qubitmapper2.default(), new _swapandcnotflipper2.default(_ibm5qubitmapper.ibmqx4_connections), new _optimize2.default(10)];
} /*
